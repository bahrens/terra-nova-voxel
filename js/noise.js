// Improved Perlin noise (Ken Perlin) with a seedable permutation table.
// Provides 2D and 3D noise plus a fractal (fBm) helper used for terrain.
...
export class Noise {
  ...
  // Fractal Brownian motion — layered octaves of noise in [-1, 1].
